...
export async function initLocationAllocation(viewDiv, infoPanel) {
  const [
    Map,
    MapView,
    Graphic,
  ...
  function solveLocationAllocation() {
    infoPanel.innerHTML = `<h3>Location Allocation</h3><p>Calculating optimal locations...</p>`;
  ...
  function updateInfoPanel(chosenFacilities, facilityStats, totalAllocations) {
    ...
    html += "<p class='info-text'>Simplified distance-based allocation algorithm</p>";
